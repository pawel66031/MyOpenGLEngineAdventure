...
public:
    ...
    void init() {
        ...
        // Texture tex0("../assets/gordon.jpg", "texture0");
        // Texture tex0("../assets/gordon.jpg", "material.diffuse");
        // tex0.load();
        // Texture tex0_spec("../assets/gordon_spec.png", "material.specular");
        // tex0_spec.load();

        // Texture tex1("../assets/t1.png", "texture1");
        // tex1.load();
